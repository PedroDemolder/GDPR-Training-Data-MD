...
10.1 Scenario 1: CB established only in country A wants to certify against a national certification
scheme X in countries A, B & C. ........................................................................................................ 18
10.2 Scenario 2: A certification body may have entities / branches in several member states of
the EU.20
10.3 Scenario 3: “Data controllers” may not be the same legal entity as the corporate entities of
...
With this in mind, it is advisable that scheme owners should be prepared to provide to an SA:

...
1) the certification applicant is not the software provider/developer/manufacturer: the ToE will
...
2) the certification applicant is the software provider/developer/manufacturer: the ToE can
...
Attention should also be paid to the fact that conformity marks should not be used in such a way as to create
a false impression of the purpose of the certification or to mislead consumers.
3
Certification under GDPR articles 42 and 43 opens the possibilities for the different stakeholders to be
...
It doesn’t exclude the potential requirement of a risk assessment method in other cases
As a certification can be perceived as an indication of compliance with the GDPR, such restrictions need to be
...
controller/processor) identifies and specifies the ToE. This should encompass the systematic
...
an evaluator can assess the processing objectively and to defined levels of
implementation;
an evaluator can determine if those criteria levels are met or not, ensuring consistent
...
the criteria are applicable to diverse contexts (sectorial context, technological
...
GDPR Article 24(3) : « Adherence to approved codes of conduct as referred to in Article 40 or approved
...
the nature of the evidence required by the evaluator is consistent: for instance, it would
...
2. In view of that, it should be clear what the objective of the criterion is in the context of the
...
different.
5. It cannot be excluded that there will be cases, where a criterion has been followed to the letter,
even while the evaluators are not persuaded that the result is GDPR compliant (for example
due to a different interpretation of the law / criteria etc.). Such a situation could lead to a nonconformity of the criterion in the long term. The auditor should write down this finding in the
...
Such flexibility may mainly apply to general certification schemes and it should be framed accordingly.
...
or mechanism is in place to effectively
...
subject request, the content of the
communication with data subjects, the followup, and if applicable, the reason for not
...
This is a specific approach, some schemes somehow include a step-by-step recipe when following the criteria
...
controller or processor may get scores and improvement suggestions based on the state-ofthe-art. In the case of certification, as well as a check-list with conditions there will also be a
...
If the applicable national regulations cannot be easily determined, this may be because the scope of the
scheme is not clear or focussed enough.
10
Approval procedure: Refer to EDPB document on the procedure for the approval of certification criteria by
the EDPB resulting in a common certification, the European Data Protection Seal (available on the EDPB
website https://edpb.europa.eu/our-work-tools/our-documents/procedure/edpb-document-procedureapproval-certification-criteria-edpb_en)
9
...
See EDPB document on the procedure for the approval of certification criteria by the EDPB resulting in a
common certification, the European Data Protection Seal.
12
See paragraph 40 of EDPB Guidelines 1/2018 on Certification and Identifying Certification Criteria.
13
Refer to EDPB Guidelines 4/2018 on the accreditation of certification bodies under Article 43 of the General
...
could include: transition periods, approvals process with competent supervisory authority,
...
See for example sections 3.2.3 and 4.2 of European Accreditation document EA-1/22 at [https://europeanaccreditation.org/publications/ea-1-22-a/]
14
...
The accreditation system of CBs envisaged by Article 43.1 and 43.3. GDPR is carried out on the basis of
...
16
As the accreditation requirements are consistent over the different countries, the risk of forum shopping for
...
What would be the consequences if country B or country C do not adopt the certification criteria and
